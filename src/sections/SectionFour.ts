        ...
        return html`
            <portfolio-section fullHeight class="secondary" id="portfolio">
                ...
                <div class="pb-16 md:pl-15% w-full">
                    <div class="secondary-card w-full flex flex-col md:flex-row items-stretch md:rounded-l-8">
                                ...
                                <div class="flex flex-col justify-between gap-4">
                                    ...
                                    <multi-height class="relative w-full">
                                        <div data-name="about" class="content active text-xl text-center m-auto absolute top-0 left-0 w-full">
                                            ...
                                            Due to the dynamic nature of the plugin, it can easily be ported to more platforms
                                            and it is easy to add more language support.
                        ...
                        <iframe class="flex-1 grow-2 min-h-75vh border-none" src="https://example.com"></iframe>
                    </div>
                </div>
