                            ...
                            <div class="flex flex-col justify-between gap-4">
                                ...
                                <multi-height class="relative w-full">
                                    <div data-name="about" class="content active text-xl text-center m-auto absolute top-0 left-0 w-full">
                                        ServerScripter is a multi-platform Java plugin that allows you to write scripts for your Minecraft servers.
                                        Due to the dynamic nature of the plugin, it can easily be ported to multiple platforms
                                        and it is easy to add support for language.
                                        The plugin has been used by MC-Galaxy for over a year now and has been proven to be stable.
                                        It has been very useful in speeding up the development of the server by allowing rapid
                                    ...
                                    <div data-name="platforms" class="content text-xl text-center m-auto absolute top-0 left-0 w-full">
                                        <ul class="text-left m-0">
                                    ...
                                    <div data-name="languages" class="content text-xl text-center m-auto absolute top-0 left-0 w-full">
                                        <ul class="text-left m-0">
                                            <li>Python - The original plugin <a href="https://github.com/SelfMadeSystem/SPYgotUtils" target="_blank">SPYgotUtils</a> was written for Python.
                                            Support is via <a href="https://www.jython.org" target="_blank">Jython</a> or <a href="https://www.graalvm.org" target="_blank">GraalVM</a>.</li>
                                            <li>JavaScript - Support is via <a href="http://mozilla.github.io/rhino/" target="_blank">Rhino</a> or <a href="https://www.graalvm.org" target="_blank">GraalVM</a>.</li>
                                            <li>Groovy - Support is via <a href="https://www.groovy-lang.org" target="_blank">Groovy</a>.</li>
                                            <li>R - Support is via <a href="https://www.graalvm.org" target="_blank">GraalVM</a>.</li>
                                        </ul>
                                    </div>
                                </multi-height>
                            </div>
                        </portfolio-card>
                        <a class="button m-8 mx-auto" href="https://github.com/SelfMadeSystem/ServerScripter" target="_blank">Visit</a>
                    </div>
                    ...
                    <div class="secondary-card flex-1 grow-1 flex flex-col justify-between rounded-8 max-w-lg">
                        <portfolio-card class="portfolio-card flex flex-col-reverse justify-between gap-xl p-8">
                            ...
                            <div class="flex flex-col justify-between gap-4">
                                ...
                                <multi-height class="relative w-full">
                                    <div data-name="about" class="content active text-xl text-center m-auto absolute top-0 left-0 w-full">
                                        MyDiscordBot is a simple and easily extendable Discord bot. It doesn't come with many features
                                        built-in, but it is rather used as a base to easily build your own bot. It has been used as the
                                        base of the BigSister bot, a custom-made bot used by MC-Galaxy.
                                    </div>
                                    <div data-name="technologies" class="content text-xl text-center m-auto absolute top-0 left-0 w-full">
                                        <ul class="text-left m-0">
                        ...
                        <a class="button m-8 mx-auto" href="https://github.com/SelfMadeSystem/MyDiscordBot" target="_blank">Visit</a>
                    </div>
