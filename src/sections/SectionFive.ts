    ...
    render() {
        ...
        <portfolio-section class="primary z-1" id="contact">
            ...
            <div class="pb-16 md:pr-15% w-full">
                <div class="primary-card w-full flex flex-col md:flex-row items-stretch md:rounded-r-8">
                ...
                <!-- TODO: Update xinarow so that we can disable online play if on CF pages... or get a cheap (free?) way to host it -->
            </div>
