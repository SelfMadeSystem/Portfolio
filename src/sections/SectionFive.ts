            ...
            <div class="pb-16 md:pl-15% w-full z-2">
                <div class="primary-card right w-full flex flex-col md:flex-row items-stretch md:rounded-l-8">
                    <div class="flex-1 grow-1 flex flex-col justify-between">
                        ...
                        <a class="button mb-8 mx-auto" href="https://minesvelte.shoghisimon.cc" target="_blank">Visit</a>
                        <a class="button mb-8 mx-auto" href="https://github.com/SelfMadeSystem/Minesvelte" target="_blank">Source Code</a>
                    </div>
                    ...
                    <div class="flex-1 grow-1 flex flex-col justify-between">
                        <portfolio-card class="portfolio-card flex flex-col-reverse justify-between gap-xl p-8 rounded-8">
                            ...
                            <div class="flex flex-col justify-between gap-4">
                                ...
                                <multi-height class="relative w-full">
                                    <div data-name="about" class="content active text-xl text-center m-auto absolute top-0 left-0 w-full">
                                        A Walk Around The Block is a puzzle game where you play as a block and you have to rotate around
                                        other blocks to get to a goal. I wrote my IB Math paper about the collision system used in this
                                        game.
                                        <p>
                                            Note: still in development. Please contact me if you want a demo.
                                        </p>
                                    </div>
                                    <div data-name="technologies" class="content text-xl text-center m-auto absolute top-0 left-0 w-full">
                                        <ul class="text-left m-0">
                                            <li>Godot - The game engine used. Mostly for UI, its awesome node system, and rendering.</li>
                                            <li>C# - Used to implement everything else, including the collision system.</li>
                                        </ul>
                                    </div>
                                </multi-height>
                            </div>
            ...
            <div class="pb-16 md:pl-15% w-full z-2">
                <div class="primary-card right w-full flex flex-col md:flex-row items-stretch md:rounded-l-8">
                    <div class="flex-1 grow-1 flex flex-col justify-between">
                        ...
                        <a class="button mb-8 mx-auto" href="https://xinarow.shoghisimon.cc" target="_blank">Visit</a>
                        <a class="button mb-8 mx-auto" href="https://github.com/SelfMadeSystem/XInARow" target="_blank">Source Code</a>
                    </div>
                    <div class="separator"></div>
                    <iframe class="flex-1 grow-2 min-h-75vh border-none" src="https://xinarow.shoghisimon.cc"></iframe>
                </div>
            </div>

            <div class="pb-16 md:pr-15% w-full z-2">
                <div class="primary-card left w-full flex flex-col md:flex-row items-stretch md:rounded-r-8">
                    <iframe class="flex-1 grow-2 min-h-75vh border-none" src="https://www.youtube.com/embed/yaZyVcugjh4?si=kIUTAXE7Fsd5_q3N" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                    <div class="separator"></div>
                    <div class="flex-1 grow-1 flex flex-col justify-between">
                        <portfolio-card class="portfolio-card flex flex-col-reverse justify-between gap-xl p-8 rounded-8">
                            <div class="flex flex-row items-center justify-center">
                            ...
                            <div class="flex flex-col justify-between gap-4">
                                ...
                                <multi-height class="relative w-full">
                                    <div data-name="about" class="content active text-xl text-center m-auto absolute top-0 left-0 w-full">
                                        mc-parkou-rs is a Minecraft parkour server written in Rust. 
                                        It is currently in development and is not yet readily available.
                                        It uses a variety of complex algorithms to generate parkour courses, such as
                                        a prediction algorithm to predict the player's movement and a path creation
                                        algorithm to generate the course.
                                    </div>
                                    <div data-name="technologies" class="content text-xl text-center m-auto absolute top-0 left-0 w-full">
                                        <ul class="text-left m-0">
                                            <li>Rust - The programming language used.</li>
                                            <li><a href="https://valence.rs" target="_blank">Valence</a> - The Minecraft server framework used.</li>
                                        </ul>
                                    </div>
                                </multi-height>
                            </div>
                        </portfolio-card>
                        <a class="button mb-8 mx-auto" href="https://github.com/SelfMadeSystem/mc-parkou-rs" target="_blank">Source Code</a>
                    </div>
                </div>
            </div>
