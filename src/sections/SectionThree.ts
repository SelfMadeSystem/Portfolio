                        ...
                        <portfolio-card class="portfolio-card flex flex-col-reverse justify-between gap-xl">
                            ...
                            <div class="flex flex-col justify-between gap-4 w-max max-w-[calc(100vw-2rem)]">
                                ...
                                <multi-height class="relative w-full">
                                    ...
                                    >
                                        I've been crafting web experiences since 2018, from simple business sites to 
                                        complex applications that serve millions. Each project taught me something new 
                                        and pushed the boundaries of what's possible on the web.
                                    </div>
                                    <div
